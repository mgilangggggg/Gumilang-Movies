...
<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center">
    ...
    <div class="w-1/3 flex items-center justify-center">
        <a href="/tv-shows" class="uppercase text-base mx-5 text-black hover:text-sky-500 duration-200 font-inter">Tv
            Show</a>
        <a href="/movies"
            class="uppercase text-base mx-5 text-black hover:text-sky-500 duration-200 font-inter">Movies</a>
    </div>
    ...
    <a href="" rel="noopener noreferrer">
        <div class="bg-develobe-500 rounded-md text-white group-hover:drop-shadow-lg px-6 py-3 duration-200">Masuk</div>
    </a>
